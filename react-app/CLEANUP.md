...
- ✅ `vendor/` - PHP dependencies (PHPMailer, etc.)
  - Note: PHPMailer functionality is now in `/react-app/server` with Nodemailer
...
- [x] PHPMailer replaced with Node.js/Nodemailer API
...
- PHP dependencies are replaced by Node.js
