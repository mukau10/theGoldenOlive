...
class PaymentHelper extends Helper {
  ...
  getSettlement() {
    var _runIf5;
    if (renege(this, this.getSettlement, ...arguments)) return;
    return (_runIf5 = ruply.runIf(this.links.settlement, ({
      href
  ...
  getCustomer() {
    ...
    return (_runIf6 = ruply.runIf(this.links.customer, ({
      href
  ...
  getMandate() {
    ...
    return (_runIf7 = ruply.runIf(this.links.mandate, ({
      href
  ...
  getSubscription() {
    ...
    return (_runIf8 = ruply.runIf(this.links.subscription, ({
      href
  ...
  getTerminal() {
    ...
    return (_runIf9 = ruply.runIf(this.links.terminal, ({
      href
...
class SubscriptionHelper extends Helper {
  ...
  getMandate() {
    var _runIf;
    if (renege(this, this.getMandate, ...arguments)) return;
    return (_runIf = ruply.runIf(this.links.mandate, ({
      href
    }) => breakUrl(href), ([pathname, query]) => this.networkClient.get(pathname, query))) !== null && _runIf !== void 0 ? _runIf : undefinedPromise;
  }
  ...
  getProfile() {
    ...
    return (_runIf2 = ruply.runIf(this.links.profile, ({
      href
    }) => breakUrl(href), ([pathname, query]) => this.networkClient.get(pathname, query))) !== null && _runIf2 !== void 0 ? _runIf2 : undefinedPromise;
  }
...
class SettlementHelper extends Helper {
  ...
  getInvoice() {
    ...
    return (_runIf = ruply.runIf(this.links.invoice, ({
      href
    }) => breakUrl(href), ([pathname, query]) => this.networkClient.get(pathname, query))) !== null && _runIf !== void 0 ? _runIf : undefinedPromise;
  }
}
...
function withParameterDefaults(target, networkClient, config) {
  Object.defineProperties(target, Object.entries(config).reduce((descriptors, [method, keys]) => ruply.apply(descriptors, descriptors => {
...
exports.CaptureEmbed = CaptureEmbed;
...
exports.PairingCodeStatus = PairingCodeStatus;
...
exports.TerminalPairingCodeInclude = TerminalPairingCodeInclude;
