...
const _excluded$y = ["idempotencyKey"],
  _excluded2$m = ["idempotencyKey"];
  ...
  post(pathname, data, query) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const {
        ...
        body = _objectWithoutProperties(data, _excluded$y);
      const config = {
        method: 'POST',
  ...
  delete(pathname, context) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const _ref = context !== null && context !== void 0 ? context : {},
        ...
        body = _objectWithoutProperties(_ref, _excluded2$m);
      const config = {
        method: 'DELETE',
        headers: idempotencyKey ? {
          [idempotencyHeaderName]: idempotencyKey
...
function transform$p(networkClient, input) {
  let _embedded;
  if (input._embedded != undefined) {
    _embedded = {};
    if (input._embedded.payment != undefined) {
      _embedded.payment = transform$l(networkClient, input._embedded.payment);
    }
  }
...
function transform$n(networkClient, input) {
  ...
  if (input.lines != undefined) {
    lines = input.lines.map(transform$o);
  }
...
function transform$m(networkClient, input) {
  let _embedded;
  if (input._embedded != undefined) {
    _embedded = {};
    if (input._embedded.payment != undefined) {
...
class PaymentHelper extends Helper {
  ...
  getSettlement() {
    var _runIf5;
    if (renege(this, this.getSettlement, ...arguments)) return;
    return (_runIf5 = runIf(this.links.settlement, ({
      href
    }) => breakUrl(href), ([pathname, query]) => this.networkClient.get(pathname, query))) !== null && _runIf5 !== void 0 ? _runIf5 : undefinedPromise;
  }
  ...
  getCustomer() {
    ...
    return (_runIf6 = runIf(this.links.customer, ({
      href
    }) => breakUrl(href), ([pathname, query]) => this.networkClient.get(pathname, query))) !== null && _runIf6 !== void 0 ? _runIf6 : undefinedPromise;
  }
  ...
  getMandate() {
    ...
    return (_runIf7 = runIf(this.links.mandate, ({
      href
    }) => breakUrl(href), ([pathname, query]) => this.networkClient.get(pathname, query))) !== null && _runIf7 !== void 0 ? _runIf7 : undefinedPromise;
  }
  ...
  getSubscription() {
    ...
    return (_runIf8 = runIf(this.links.subscription, ({
      href
    }) => breakUrl(href), ([pathname, query]) => this.networkClient.get(pathname, query))) !== null && _runIf8 !== void 0 ? _runIf8 : undefinedPromise;
  }
  ...
  getTerminal() {
    ...
    return (_runIf9 = runIf(this.links.terminal, ({
      href
    }) => breakUrl(href), ([pathname, query]) => this.networkClient.get(pathname, query))) !== null && _runIf9 !== void 0 ? _runIf9 : undefinedPromise;
  }
   ...
   * @since 4.6.0
   */
  getMobileAppCheckoutUrl() {
    var _this$links$mobileApp, _this$links$mobileApp2;
    return (_this$links$mobileApp = (_this$links$mobileApp2 = this.links.mobileAppCheckout) === null || _this$links$mobileApp2 === void 0 ? void 0 : _this$links$mobileApp2.href) !== null && _this$links$mobileApp !== void 0 ? _this$links$mobileApp : null;
  }
}
...
function transform$l(networkClient, input) {
  ...
  if (input._embedded != undefined) {
    ...
    if (input._embedded.chargebacks != undefined) {
      _embedded.chargebacks = input._embedded.chargebacks.map(transform$p.bind(undefined, networkClient));
    }
    if (input._embedded.refunds != undefined) {
      _embedded.refunds = input._embedded.refunds.map(transform$n.bind(undefined, networkClient));
    }
    if (input._embedded.captures != undefined) {
      _embedded.captures = input._embedded.captures.map(transform$m.bind(undefined, networkClient));
    }
  }
...
class SubscriptionHelper extends Helper {
  ...
  getMandate() {
    var _runIf;
    if (renege(this, this.getMandate, ...arguments)) return;
    return (_runIf = runIf(this.links.mandate, ({
      href
    }) => breakUrl(href), ([pathname, query]) => this.networkClient.get(pathname, query))) !== null && _runIf !== void 0 ? _runIf : undefinedPromise;
  }
  ...
  getProfile() {
    ...
    return (_runIf2 = runIf(this.links.profile, ({
      href
    }) => breakUrl(href), ([pathname, query]) => this.networkClient.get(pathname, query))) !== null && _runIf2 !== void 0 ? _runIf2 : undefinedPromise;
  }
...
const _excluded$x = ["embed"],
  _excluded2$l = ["valuesPerMinute"];
const pathSegment$i = 'orders';
...
class OrdersBinder extends Binder {
  ...
  create(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded$x);
    const query = embed != undefined ? {
      embed
    } : undefined;
    return this.networkClient.post(pathSegment$i, data, query);
  }
  ...
  get(id, parameters) {
    ...
    return this.networkClient.get(`${pathSegment$i}/${id}`, parameters);
  }
  ...
  page(parameters) {
    ...
    return this.networkClient.page(pathSegment$i, 'orders', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded2$l);
    return this.networkClient.iterate(pathSegment$i, 'orders', query, valuesPerMinute);
  }
  ...
  update(id, parameters) {
    ...
    assertWellFormedId(id, 'order');
    return this.networkClient.patch(`${pathSegment$i}/${id}`, parameters);
  }
  ...
  cancel(id, parameters) {
    ...
    assertWellFormedId(id, 'order');
    return this.networkClient.delete(`${pathSegment$i}/${id}`, parameters);
  }
}

const _excluded$w = ["orderId"],
  _excluded2$k = ["orderId"],
  _excluded3$8 = ["orderId"],
  _excluded4$5 = ["orderId"];
...
class OrderShipmentsBinder extends Binder {
  ...
  create(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded$w);
  ...
  get(id, parameters) {
    ...
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded2$k);
    assertWellFormedId(orderId, 'order');
  ...
  update(id, parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded4$5);
    assertWellFormedId(orderId, 'order');
    return this.networkClient.patch(`${getPathSegments$i(orderId)}/${id}`, data);
  }
}

const _excluded$v = ["orderId"],
...
class OrderHelper extends Helper {
  ...
  getPayments() {
    ...
    // payments embedded.
    this.networkClient.get(`${pathSegment$i}/${this.id}`, {
...
function transform$f(networkClient, input) {
  ...
  if (input._embedded != undefined) {
    ...
    if (input._embedded.payments != undefined) {
      _embedded.payments = input._embedded.payments.map(transform$l.bind(undefined, networkClient));
    }
    if (input._embedded.refunds != undefined) {
      _embedded.refunds = input._embedded.refunds.map(transform$n.bind(undefined, networkClient));
    }
    if (input._embedded.shipments != undefined) {
      _embedded.shipments = input._embedded.shipments.map(transform$g.bind(undefined, networkClient));
    }
  }
...
class OrganizationHelper extends Helper {
  constructor(networkClient, links) {
    super(networkClient, links);
    this.links = links;
  }
   ...
   */
  getDashboardUrl() {
    var _this$links$dashboard, _this$links$dashboard2;
    return (_this$links$dashboard = (_this$links$dashboard2 = this.links.dashboard) === null || _this$links$dashboard2 === void 0 ? void 0 : _this$links$dashboard2.href) !== null && _this$links$dashboard !== void 0 ? _this$links$dashboard : null;
  }
}
...
class SettlementHelper extends Helper {
  ...
  getInvoice() {
    ...
    return (_runIf = runIf(this.links.invoice, ({
      href
    }) => breakUrl(href), ([pathname, query]) => this.networkClient.get(pathname, query))) !== null && _runIf !== void 0 ? _runIf : undefinedPromise;
  }
}
...
class TerminalPairingCodeHelper extends Helper {
  constructor(networkClient, links) {
    super(networkClient, links);
    this.links = links;
  }
  ...
  getProfile() {
    if (renege(this, this.getProfile, ...arguments)) return;
    return this.networkClient.get(...breakUrl(this.links.profile.href));
  }
}
...
class RouteHelper extends Helper {
  ...
  getPayment() {
    if (renege(this, this.getPayment, ...arguments)) return;
    return this.networkClient.get(...breakUrl(this.links.payment.href));
  }
}
...
function transform$2(networkClient, input) {
  ...
  if (input._embedded != undefined) {
    ...
    if (input._embedded.organization != undefined) {
      _embedded.organization = transform$d(networkClient, input._embedded.organization);
    }
    if (input._embedded.onboarding != undefined) {
      _embedded.onboarding = transform$a(networkClient, input._embedded.onboarding);
    }
...
class InvoiceHelper extends Helper {
   ...
   */
  getPdfUrl() {
    var _this$links$pdf$href, _this$links$pdf;
    return (_this$links$pdf$href = (_this$links$pdf = this.links.pdf) === null || _this$links$pdf === void 0 ? void 0 : _this$links$pdf.href) !== null && _this$links$pdf$href !== void 0 ? _this$links$pdf$href : null;
  }
}
 ...
 */
function applyDefaults(defaults, parameters, keys) {
  ...
  for (const key of keys) {
    ...
    if (value !== undefined && result[key] === undefined) {
      result = result === parameters ? _objectSpread2({}, parameters) : result;
      result[key] = value;
    }
  }
  return result;
 ...
 */
function withParameterDefaults(target, networkClient, config) {
  Object.defineProperties(target, Object.entries(config).reduce((descriptors, [method, keys]) => apply(descriptors, descriptors => {
    ...
    descriptors[method] = {
      ...
      value(...args) {
        ...
        const base = hasParameters ? parameters : {};
        const filled = applyDefaults(networkClient.parameterDefaults, base, keys);
...
class ApplePayBinder {
  constructor(networkClient) {
    ...
    withParameterDefaults(this, networkClient, {
      requestPaymentSession: ['profileId']
    });
  }
...
const _excluded$u = ["valuesPerMinute"];
const pathSegment$h = 'chargebacks';
class ChargebacksBinder extends Binder {
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$h, 'chargebacks', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded$u);
    return this.networkClient.iterate(pathSegment$h, 'chargebacks', query, valuesPerMinute);
  }
}

const _excluded$t = ["customerId"],
  _excluded2$i = ["customerId"],
  _excluded3$6 = ["customerId"],
  _excluded4$4 = ["customerId", "valuesPerMinute"],
...
class CustomerMandatesBinder extends Binder {
  ...
  iterate(parameters) {
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded4$4);
    assertWellFormedId(customerId, 'customer');
...
class CustomerPaymentsBinder extends Binder {
  ...
  create(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded$s);
    assertWellFormedId(customerId, 'customer');
...
const _excluded$r = ["valuesPerMinute"];
const pathSegment$g = 'customers';
class CustomersBinder extends Binder {
  ...
  create(parameters) {
    if (renege(this, this.create, ...arguments)) return;
    return this.networkClient.post(pathSegment$g, parameters);
  }
  ...
  page(parameters) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$g, 'customers', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded$r);
    return this.networkClient.iterate(pathSegment$g, 'customers', query, valuesPerMinute);
  }
...
const pathSegment$f = 'methods';
class MethodsBinder extends Binder {
  constructor(networkClient) {
    super();
    this.networkClient = networkClient;
    withParameterDefaults(this, networkClient, {
      get: ['testmode', 'profileId'],
      list: ['testmode', 'profileId']
    });
    alias(this, {
      list: ['all', 'page']
    });
  ...
  get(id, parameters) {
    if (renege(this, this.get, ...arguments)) return;
    return this.networkClient.get(`${pathSegment$f}/${id}`, parameters);
  }
  ...
  list(parameters = {}) {
    if (renege(this, this.list, ...arguments)) return;
    return this.networkClient.list(pathSegment$f, 'methods', parameters);
  }
}
...
class OrderLinesBinder extends Binder {
  ...
  cancel(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded2$f);
    assertWellFormedId(orderId, 'order');
...
const pathSegment$e = 'organizations';
class OrganizationsBinder extends Binder {
  ...
  getCurrent() {
    ...
    return this.networkClient.get(`${pathSegment$e}/me`);
  }
  ...
  getPartnerStatus() {
    ...
    return this.networkClient.get(`${pathSegment$e}/me/partner`);
  }
}
 ...
 */
function foldParameters(parameters, folds) {
  return Object.entries(folds).reduce((result, [to, sources]) => (Array.isArray(sources) ? sources : [sources]).reduce((acc, from) => {
    var _acc$to;
    if (!(from in acc)) {
      return acc;
    }
    const {
      ...
      rest = _objectWithoutProperties(acc, [from].map(_toPropertyKey));
    return _objectSpread2(_objectSpread2({}, rest), {}, {
      [to]: (_acc$to = acc[to]) !== null && _acc$to !== void 0 ? _acc$to : value
    });
  }, result), parameters);
}

const _excluded$n = ["paymentId"],
  _excluded2$e = ["paymentId"],
  _excluded3$3 = ["paymentId"],
  _excluded4$2 = ["paymentId", "valuesPerMinute"];
...
class PaymentCapturesBinder extends Binder {
  ...
  get(id, parameters) {
    ...
    const _foldParameters = foldParameters(parameters, {
        embed: ['include']
      }),
      {
        paymentId
      } = _foldParameters,
      query = _objectWithoutProperties(_foldParameters, _excluded2$e);
    assertWellFormedId(paymentId, 'payment');
  ...
  page(parameters) {
    if (renege(this, this.page, ...arguments)) return;
    const _foldParameters2 = foldParameters(parameters, {
        embed: ['include']
      }),
      {
        paymentId
      } = _foldParameters2,
      query = _objectWithoutProperties(_foldParameters2, _excluded3$3);
    assertWellFormedId(paymentId, 'payment');
   ...
   */
  iterate(parameters) {
    const _foldParameters3 = foldParameters(parameters, {
        embed: ['include']
      }),
      {
        paymentId,
...
class PaymentChargebacksBinder extends Binder {
  ...
  get(id, parameters) {
    ...
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded$m);
    assertWellFormedId(paymentId, 'payment');
...
const pathSegment$d = 'payment-links';
class PaymentsLinksBinder extends Binder {
  ...
  create(parameters) {
    if (renege(this, this.create, ...arguments)) return;
    return this.networkClient.post(pathSegment$d, parameters);
  }
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$d, 'payment_links', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    return this.networkClient.iterate(pathSegment$d, 'payment_links', query, valuesPerMinute);
  }
  ...
  update(id, parameters) {
    if (renege(this, this.update, ...arguments)) return;
    assertWellFormedId(id, 'payment-link');
    return this.networkClient.patch(`${pathSegment$d}/${id}`, parameters);
  }
  ...
  delete(id, parameters) {
    if (renege(this, this.delete, ...arguments)) return;
    assertWellFormedId(id, 'payment-link');
    return this.networkClient.delete(`${pathSegment$d}/${id}`, parameters);
  }
}
...
const _excluded$j = ["include"],
  _excluded2$b = ["valuesPerMinute"];
const pathSegment$c = 'payments';
...
class PaymentsBinder extends Binder {
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$c, 'payments', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded2$b);
    return this.networkClient.iterate(pathSegment$c, 'payments', query, valuesPerMinute);
  }
  ...
  releaseAuthorization(id, parameters) {
    ...
    assertPaymentResource(id);
    return this.networkClient.post(`${pathSegment$c}/${id}/release-authorization`, parameters !== null && parameters !== void 0 ? parameters : {});
  }
}

const pathSegment$b = 'permissions';
class PermissionsBinder extends Binder {
  ...
  list() {
    if (renege(this, this.list, ...arguments)) return;
    return this.networkClient.list(pathSegment$b, 'permissions', {});
  }
}

const _excluded$i = ["valuesPerMinute"];
const pathSegment$a = 'profiles';
class ProfilesBinder extends Binder {
  ...
  getCurrent() {
    if (renege(this, this.getCurrent, ...arguments)) return;
    return this.networkClient.get(`${pathSegment$a}/me`);
  }
  ...
  page(parameters) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$a, 'profiles', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded$i);
    return this.networkClient.iterate(pathSegment$a, 'profiles', query, valuesPerMinute);
  }
...
const _excluded$h = ["id", "profileId"],
  _excluded2$a = ["id", "profileId"];
...
class ProfileMethodsBinder extends Binder {
  ...
  disable(parameters) {
    ...
    const {
      ...
      context = _objectWithoutProperties(parameters, _excluded2$a);
    assertWellFormedId(profileId, 'profile');
    return this.networkClient.delete(`${getPathSegments$8(profileId)}/${id}`, context);
  }
}

const _excluded$g = ["id", "profileId"],
...
class RefundsBinder extends Binder {
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$9, 'refunds', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    return this.networkClient.iterate(pathSegment$9, 'refunds', query, valuesPerMinute);
  }
}

const _excluded$d = ["settlementId"],
  _excluded2$7 = ["settlementId", "valuesPerMinute"];
...
class SettlementPaymentsBinder extends Binder {
  ...
  page(parameters) {
    ...
    const {
      ...
      query = _objectWithoutProperties(parameters, _excluded$d);
...
class SettlementCapturesBinder extends Binder {
  ...
  page(parameters) {
    ...
    const _foldParameters = foldParameters(parameters, {
      ...
      query = _objectWithoutProperties(_foldParameters, _excluded$c);
  ...
  iterate(parameters) {
    const _foldParameters2 = foldParameters(parameters, {
      ...
      query = _objectWithoutProperties(_foldParameters2, _excluded2$6);
...
const _excluded$9 = ["valuesPerMinute"];
const pathSegment$8 = 'settlements';
class SettlementsBinder extends Binder {
  ...
  getNext() {
    ...
    return this.networkClient.get(`${pathSegment$8}/next`);
  }
  ...
  getOpen() {
    ...
    return this.networkClient.get(`${pathSegment$8}/open`);
  }
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$8, 'settlements', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded$9);
    return this.networkClient.iterate(pathSegment$8, 'settlements', query, valuesPerMinute);
  }
}

const _excluded$8 = ["valuesPerMinute"];
const pathSegment$7 = 'subscriptions';
class SubscriptionsBinder extends Binder {
  ...
  page(parameters) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$7, 'subscriptions', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    return this.networkClient.iterate(pathSegment$7, 'subscriptions', query, valuesPerMinute);
  }
}

const _excluded$7 = ["customerId", "subscriptionId"],
  _excluded2$3 = ["customerId", "subscriptionId", "valuesPerMinute"];
...
class TerminalsBinder extends Binder {
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$6, 'terminals', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    return this.networkClient.iterate(pathSegment$6, 'terminals', query, valuesPerMinute);
  }
}

const _excluded$5 = ["include"],
  _excluded2$2 = ["valuesPerMinute"];
const pathSegment$5 = 'terminals/pairing-codes';
class TerminalPairingCodesBinder extends Binder {
  constructor(networkClient) {
    super();
  ...
  create(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded$5);
    const query = runIf(include, include => ({
      include
    }));
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$5, 'terminal-pairing-codes', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    const _ref = parameters !== null && parameters !== void 0 ? parameters : {},
      ...
      query = _objectWithoutProperties(_ref, _excluded2$2);
    return this.networkClient.iterate(pathSegment$5, 'terminal-pairing-codes', query, valuesPerMinute);
  }
  ...
  revoke(id) {
    if (renege(this, this.revoke, ...arguments)) return;
    assertWellFormedId(id, 'terminal-pairing-code');
    return this.networkClient.delete(`${pathSegment$5}/${id}`);
  }
}
...
class PaymentRoutesBinder extends Binder {
  ...
  create(parameters) {
    ...
    const {
      ...
      data = _objectWithoutProperties(parameters, _excluded$4);
    assertWellFormedId(paymentId, 'payment');
...
const pathSegment$4 = 'connect/balance-transfers';
class BalanceTransfersBinder extends Binder {
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$4, 'connect-balance-transfers', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    return this.networkClient.iterate(pathSegment$4, 'connect-balance-transfers', query, valuesPerMinute);
  }
}

const pathSegment$3 = 'capabilities';
class CapabilitiesBinder {
  ...
  list() {
    if (renege(this, this.list, ...arguments)) return;
    return this.networkClient.list(pathSegment$3, 'capabilities', {});
  }
}

const _excluded$2 = ["valuesPerMinute"];
const pathSegment$2 = 'clients';
class ClientsBinder extends Binder {
  ...
  get(id, parameters) {
    if (renege(this, this.get, ...arguments)) return;
    assertWellFormedId(id, 'organization');
    return this.networkClient.get(`${pathSegment$2}/${id}`, parameters);
  }
  ...
  page(parameters) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment$2, 'clients', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    return this.networkClient.iterate(pathSegment$2, 'clients', query, valuesPerMinute);
  }
}

const _excluded$1 = ["clientId", "clientSecret"],
...
const pathSegment$1 = 'client-links';
class ClientLinksBinder {
  ...
  create(parameters) {
    if (renege(this, this.create, ...arguments)) return;
    return this.networkClient.post(pathSegment$1, parameters);
  }
}

const _excluded = ["valuesPerMinute"];
const pathSegment = 'invoices';
class InvoicesBinder extends Binder {
  constructor(networkClient) {
    super();
    this.networkClient = networkClient;
    alias(this, {
  ...
  page(parameters = {}) {
    if (renege(this, this.page, ...arguments)) return;
    return this.networkClient.page(pathSegment, 'invoices', parameters).then(result => this.injectPaginationHelpers(result, this.page, parameters));
  }
  ...
  iterate(parameters) {
    ...
    return this.networkClient.iterate(pathSegment, 'invoices', query, valuesPerMinute);
  }
}
...
let CaptureEmbed = /*#__PURE__*/function (CaptureEmbed) {
...
let PaymentLineCategory = /*#__PURE__*/function (PaymentLineCategory) {
  ...
  PaymentLineCategory["additional"] = "additional";
  PaymentLineCategory["consume"] = "consume";
...
let PairingCodeStatus = /*#__PURE__*/function (PairingCodeStatus) {
  PairingCodeStatus["active"] = "active";
  PairingCodeStatus["expired"] = "expired";
  PairingCodeStatus["revoked"] = "revoked";
  return PairingCodeStatus;
}({});
let TerminalPairingCodeInclude = /*#__PURE__*/function (TerminalPairingCodeInclude) {
  TerminalPairingCodeInclude["qrCode"] = "details.qrCode";
  return TerminalPairingCodeInclude;
}({});
...
let SettlementStatus = /*#__PURE__*/function (SettlementStatus) {
  /**
   ...
   */
  SettlementStatus["processingAtBank"] = "processing-at-bank";
  /**
   * The settlement has been paid out.
   */
  SettlementStatus["paidout"] = "paidout";
  /**
...
function isBrowserLike() {
  ...
  return ((_globals$window = globals.window) === null || _globals$window === void 0 ? void 0 : _globals$window.document) != undefined && globals.navigator != undefined;
}
...
export { ApiMode, BalanceTransferCategory, BalanceTransferStatus, BalanceTransferStatusReasonCode, CapabilityStatus, CapabilityStatusReason, CaptureEmbed, CaptureInclude, CaptureMethod, CaptureStatus, ClientEmbed, HistoricPaymentMethod, InvoiceStatus, Locale, MandateMethod, MandateStatus, MethodImageSize, MethodInclude, ApiError as MollieApiError, GrantType as OAuthGrantType, TokenType as OAuthTokenType, OnboardingStatus, OrderEmbed, OrderLineType, OrderStatus, PairingCodeStatus, PaymentEmbed, PaymentInclude, PaymentLineCategory, PaymentLineType, PaymentMethod, PaymentStatus, ProfileStatus, RefundEmbed, RefundStatus, RequirementStatus, RoutingType, SequenceType, SettlementStatus, SubscriptionStatus, TerminalPairingCodeInclude, TerminalStatus, createMollieClient, createMollieClient as default };
