...
export type CreateParameters = Pick<OrderData, 'amount' | 'orderNumber' | 'consumerDateOfBirth' | 'webhookUrl' | 'locale' | 'expiresAt'> & PickOptional<OrderData, 'billingAddress' | 'shippingAddress' | 'redirectUrl' | 'cancelUrl' | 'metadata'> & TestModeParameter & IdempotencyParameter & {
     ...
     */
    payment?: Pick<PaymentCreateParameters, 'applePayPaymentToken' | 'cardToken' | 'consumerAccount' | 'customerId' | 'customerReference' | 'issuer' | 'mandateId' | 'sequenceType' | 'storeCredentials' | 'voucherNumber' | 'voucherPin' | 'webhookUrl' | 'applicationFee'>;
    /**
