...
export default class OrderShipmentsBinder extends Binder<ShipmentData, Shipment> {
     ...
     * @deprecated We no longer recommend using the Orders API. Please refer to the [Payments API](https://docs.mollie.com/reference/payments-api) instead. Already using the Orders API? See the [migrating from Orders to Payments guide](https://docs.mollie.com/docs/migrating-from-orders-to-payments) for more information.
     */
    create(parameters: CreateParameters): Promise<Shipment>;
    create(parameters: CreateParameters, callback: Callback<Shipment>): void;
    /**
     ...
     * @deprecated We no longer recommend using the Orders API. Please refer to the [Payments API](https://docs.mollie.com/reference/payments-api) instead. Already using the Orders API? See the [migrating from Orders to Payments guide](https://docs.mollie.com/docs/migrating-from-orders-to-payments) for more information.
     */
    get(id: string, parameters: GetParameters): Promise<Shipment>;
    get(id: string, parameters: GetParameters, callback: Callback<Shipment>): void;
    /**
     ...
     * @deprecated We no longer recommend using the Orders API. Please refer to the [Payments API](https://docs.mollie.com/reference/payments-api) instead. Already using the Orders API? See the [migrating from Orders to Payments guide](https://docs.mollie.com/docs/migrating-from-orders-to-payments) for more information.
     */
    list(parameters: ListParameters): Promise<Shipment[]>;
    list(parameters: ListParameters, callback: Callback<Shipment[]>): void;
    /**
     ...
     * @deprecated We no longer recommend using the Orders API. Please refer to the [Payments API](https://docs.mollie.com/reference/payments-api) instead. Already using the Orders API? See the [migrating from Orders to Payments guide](https://docs.mollie.com/docs/migrating-from-orders-to-payments) for more information.
     */
    update(id: string, parameters: UpdateParameters): Promise<Shipment>;
    update(id: string, parameters: UpdateParameters, callback: Callback<Shipment>): void;
}
