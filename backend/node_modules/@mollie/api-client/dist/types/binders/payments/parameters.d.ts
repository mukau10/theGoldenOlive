...
export type UpdateParameters = Pick<PaymentData, 'redirectUrl' | 'cancelUrl' | 'webhookUrl' | 'billingAddress' | 'shippingAddress' | 'issuer'> & PickOptional<PaymentData, 'description' | 'metadata' | 'locale'> & TestModeParameter & {
    /**
     * For digital goods in most jurisdictions, you must apply the VAT rate from your customer's country. Choose the VAT rates you have used for the order to ensure your customer's country matches the
     * VAT country.
     *
