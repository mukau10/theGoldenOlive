...
export default class OrganizationsBinder extends Binder<OrganizationData, Organization> {
    ...
    get(id: string, parameters: GetParameters): Promise<Organization>;
    get(id: string, parameters: GetParameters, callback: Callback<Organization>): void;
    /**
    ...
    getPartnerStatus(callback: Callback<PartnerStatus>): void;
}
